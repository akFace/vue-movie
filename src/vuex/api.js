...
export default {
    ...
    getComingNewList({ commit, state }, params) {
        return Vue.http.get('library/movie/listOtherComingMovies.api', { params });
    },
    ...
    getLocationMovies({ commit, state }, params) {
        return Vue.http.get('ticket/schedule/movie/coming_list.api', { params });
    },
    ...
    getMovieDetail({ commit, state }, params) {
        return Vue.http.get('library/movie/detail.api', { params });
    },
    ...
    getMovieComments({ commit, state }, params) {
        return Vue.http.get('library/movie/comment.api', { params });
    },
    ...
    getHotLongComments({ commit, state }, params) {
        return Vue.http.get('library/movie/longCommentList.api', { params });
    },
